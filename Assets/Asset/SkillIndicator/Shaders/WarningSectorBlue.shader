Shader "taecg/SkillIndicator/BlueCircle" 
{
    Properties 
    {
        ...
        [Header(Blend)]
        //��Ϸ��?        [Enum(UnityEngine.Rendering.BlendMode)] _SrcBlend("Src Blend Mode", Float) = 1
    ...
    SubShader 
    {
        ...
        Pass 
        {
            ...
            float4 frag(v2f i) : SV_Target 
            {
                ...
                //��һ����������������ߵ�����?                fixed sectorBig = lerp(1.0, 1.0 - ceil(atan2UV - (_Angle + _Outline) * 0.002777778), _Sector);
                ...
                //Բ�ε�����
                fixed flowCircleInner = smoothstep(_Duration - _FlowFade, _Duration, length(centerUV));	//��������?                fixed flowCircleMask = step(length(centerUV), _Duration);	//Ӳ������
